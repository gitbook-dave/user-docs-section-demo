...
<figure><img src="../../../../.gitbook/assets/image (59) (1).png" alt="Select Severity settings for IaC scans"><figcaption><p>Select Severity settings for IaC scans</p></figcaption></figure>
