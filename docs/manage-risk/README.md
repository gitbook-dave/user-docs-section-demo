...
[Analytics](manage-risk/analytics/) shows the performance of a company's Application Security program.
...
Use Snyk [Reporting](manage-risk/reporting/) to track issues and their resolution.
...
For more information, see [Available Snyk Reports](manage-risk/reporting/available-snyk-reports.md).

## Risk Score

Snyk [Risk Score](manage-risk/prioritize-issues-for-fixing/risk-score.md) can help you prioritize your approach to security issues, by providing you with an accurate and holistic understanding of the risk posed by a given security issue.
