...
* [Quickstart guides for several AI assistants](integrations/snyk-studio-agentic-integrations/quickstart-guides-for-snyk-studio/)
* [Troubleshooting for the Snyk MCP Server](integrations/snyk-studio-agentic-integrations/troubleshooting.md)
...
Integrations for [event forwarding](integrations/event-forwarding/) allow you to push Snyk platform events directly to certain products on other platforms, enabling you to set up custom alerting, build your own reporting, trigger automation, and more.

[Notification and ticketing systems integrations](integrations/jira-and-slack-integrations/) help you work with Snyk in Jira and Slack.

Information is also provided on how Snyk can work with [vulnerability management tools](integrations/partner-integrations.md).
...
* [Jira](integrations/jira-and-slack-integrations/jira-integration.md)
* [Slack](integrations/jira-and-slack-integrations/slack-integration.md)
* Email
